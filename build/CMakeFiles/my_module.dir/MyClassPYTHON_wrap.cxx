...
/*-----------------------------------------------
              @(target):= _my_module.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__my_module

#else
#  define SWIG_init    init_my_module

#endif
#define SWIG_name    "_my_module"
...
SWIGINTERN PyObject *_wrap_MyClass_sayHello(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_delete_MyClass(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  MyClass *arg1 = (MyClass *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "MyClass_sayHello", _wrap_MyClass_sayHello, METH_O, NULL},
